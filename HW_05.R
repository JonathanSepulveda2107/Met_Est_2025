#Jonathan alfredo sepulveda flores
# Instrucciones: 
# ===============================
...
plot(x, y1, main="Conjunto I", pch=19, col="yellow")
abline(lm(y1 ~ x), col="red")
plot(x, y2, main="Conjunto II", pch=19, col="yellow")
abline(lm(y2 ~ x), col= "red")
plot(x, y3, main="Conjunto III", pch=19, col="yellow")
abline(lm(y3 ~ x), col="red")
plot(x, y4, main="Conjunto IV", pch=19, col="yellow")
